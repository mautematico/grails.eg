	...
	<body>
		...
		<div id="show-persona" class="content scaffold-show" role="main">
			...
			<ol class="property-list persona">
				...
				<g:if test="${personaInstance?.iban}">
				<li class="fieldcontain">
					<span id="iban-label" class="property-label"><g:message code="persona.iban.label" default="Iban" /></span>
					
						<span class="property-value" aria-labelledby="iban-label"><g:fieldValue bean="${personaInstance}" field="iban"/></span>
